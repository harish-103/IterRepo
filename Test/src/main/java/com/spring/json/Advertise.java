...
public class Advertise 
{
	...
	public Advertise(String title, String name, String category, String description, String postId,
	...
	public Advertise( long id,String title, String name, String category, String description) 
	{
		super();
		this.id=id;
		this.title = title;
